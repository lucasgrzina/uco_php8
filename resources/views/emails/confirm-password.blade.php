    ...
    <body style="margin:0; padding:0;">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#f5f5f5;">
                                ...
                                <td style="direction:ltr;font-size:0px;padding:0;text-align:center;vertical-align:top; ">
                                    ...
                                    <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width: 100%; max-width: 100%;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top; background-color: #f5f5f5;" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="font-family: Helvetica, Arial, sans-serif;font-size: 21px; line-height: 20px; color: #FF5A00; border-color: #f5f5f5; border-width:0 55px 55px 55px;     border-style: solid; font-weight: 400; padding:0; background-color: #ffffff; text-align: center;">
                                                        <img src="{{asset('img/mailings/'.trans('emails.confirmarPass.imagenes.recupera'))}}" border="0" width="100%;" height="auto" >
                                                        ...
                                                        <div style="max-width: 350px; width: 100%; font-family: Helvetica, Arial, sans-serif; font-size:13px; line-height:18px; text-align:left; color:#000000; font-weight: normal; text-align: center; margin: 0 auto; padding: 15px;">
                                                            {!! trans('emails.confirmarPass.linea3') !!}
                                                        </div>
                                                        <div style="max-width: 350px; width: 100%; font-family: Helvetica, Arial, sans-serif; font-size:20px; line-height:24px; text-align:left; color:#000000; font-weight: normal; text-align: center; margin: 0 auto; padding: 15px;">
                                                            {!! trans('emails.confirmarPass.linea4') !!}
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <!--tr>
                                                <td align="center">
                                                    <div style="font-family: Helvetica, Arial, sans-serif;font-size:12px;line-height:24px;text-align:center;color:#FFF;padding:10px; background-color:#cdcfad; min-width: 240px;max-width: 55%;"><a href="{{routeIdioma('login')}}" style="color:#000000; text-decoration: none; font-weight: bold;">{!! trans('emails.confirmarPass.btn_texto') !!}</a>
                                                    </div>
                                                </td>
                                            </tr-->
