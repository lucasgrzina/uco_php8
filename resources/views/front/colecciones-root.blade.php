		...
		<div class="row">
			...
			<div class="col-md-5 col-text">
				<div class="wrap-text fade_JS">
					...
					<a href="{{routeIdioma('colecciones.tucci')}}" class="btn-primary btn-marron-claro d-none" style="float: right;">{!! trans('front.paginas.colecciones.root.francescaTucci.btn') !!}</a>
				</div>
			</div>
		</div>
	</div>
