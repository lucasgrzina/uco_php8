    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="nav-lenguage mobile">
          <li><a href="{{route('cambiarIdioma',['es',\Route::currentRouteName()])}}?{{implode('&',\Route::getCurrentRoute()->parameters())}}" class="{{app()->getLocale() === 'es' ? 'active' : ''}}">ESP</a></li>
          <li><a href="{{route('cambiarIdioma',['en',\Route::currentRouteName()])}}?{{implode('&',\Route::getCurrentRoute()->parameters())}}" class="{{app()->getLocale() === 'en' ? 'active' : ''}}">ENG</a></li>
          <li><a href="{{route('cambiarIdioma',['pt',\Route::currentRouteName()])}}?{{implode('&',\Route::getCurrentRoute()->parameters())}}" class="{{app()->getLocale() === 'pt' ? 'active' : ''}}">POR</a></li>
      ...
      <div class="nav-right">
        <ul class="nav-lenguage desktop">
          <li><a href="{{route('cambiarIdioma',['es',\Route::currentRouteName()])}}?params={{implode('|',\Route::getCurrentRoute()->parameters())}}" class="{{app()->getLocale() === 'es' ? 'active' : ''}}">ESP</a></li>
          <li><a href="{{route('cambiarIdioma',['en',\Route::currentRouteName()])}}?params={{implode('|',\Route::getCurrentRoute()->parameters())}}" class="{{app()->getLocale() === 'en' ? 'active' : ''}}">ENG</a></li>
          <li><a href="{{route('cambiarIdioma',['pt',\Route::currentRouteName()])}}?params={{implode('|',\Route::getCurrentRoute()->parameters())}}" class="{{app()->getLocale() === 'pt' ? 'active' : ''}}">POR</a></li>
