...
use App\Http\Requests\Admin\CUPaisRequest;
use App\Repositories\PaisRepository;
use Illuminate\Http\Request;
use Prettus\Repository\Criteria\RequestCriteria;
use Response;

class PaisController extends CrudAdminController
{
    protected $routePrefix = 'pais';
    protected $viewPrefix  = 'admin.pais.';
    protected $actionPerms = 'pais';
    ...
    public function store(CUPaisRequest $request)
    {
    ...
    public function update($id, CUPaisRequest $request)
    {
